...
public class PwU2P4TDcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println(
				"JOIN FETCH ");
		List<Escuela> reporte10 = this.escuelaService.encontrarFetch();
		for (Escuela escuela2 : reporte10) {
			System.out.println(escuela2);
		}
		System.out.println("11.-");
		System.out.println(
				"JOIN FETCH ");
		List<Alumno> reporte11 = this.alumnoService.encontrarFetch();
		for (Alumno al : reporte11) {
