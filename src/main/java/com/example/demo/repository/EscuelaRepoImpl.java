...
public class EscuelaRepoImpl implements IEscuelaRepo {
	...
	//RIGH
		...
		@Override
		public List<Escuela> seleccionarFetch() {
			// TODO Auto-generated method stub
			TypedQuery<Escuela> query= this.entityManager.createQuery("SELECT es FROM Escuela es JOIN FETCH es.alumnos al", Escuela.class);
			return query.getResultList();
		}
}
